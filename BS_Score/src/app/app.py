...
def adc():
    if request.method == 'POST':
        ...
        coment['Balanced'],coment['HarshBitterness'],coment['Malty'],coment['Cooked'],coment['GreenApple(acetaldehyde)'],
        ...
        coment['Solventy'],coment['Buttery(diacetyl)'],coment['Yeasty'],coment['Grainy'],
        coment['Thin'],coment['FreshlyCutGrass'],coment['Honey'],coment['Fruity:Banana(Isoamyl acetate)'],
        coment['SweetCorn(DMS)'],coment['Sour'],coment['RottenEggs(H2S)'],coment['Sulfury:Onion'],
        coment['Almond'],coment['Winey'],coment['Light-struck-skunky']]]) 
